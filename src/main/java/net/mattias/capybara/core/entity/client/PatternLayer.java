...
//
//public class PatternLayer extends RenderLayer<CapybaraEntity, CapybaraModel<CapybaraEntity>> {
//    private final CapybaraModel<CapybaraEntity> model;
//
//    public PatternLayer(RenderLayerParent<CapybaraEntity, CapybaraModel<CapybaraEntity>> parent) {
//        super(parent);
...
//
//        int variant = capybara.getPatternVariant();
//        if (variant <= 0) {
//            return;
//        }
//
...
//                Capybara.MOD_ID,
//                "textures/entity/capybarapatterns/capybara_pattern_" + variant + ".png"
//        );
//
