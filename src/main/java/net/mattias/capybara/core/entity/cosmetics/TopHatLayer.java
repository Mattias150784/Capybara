...
public class TopHatLayer extends RenderLayer<CapybaraEntity, CapybaraModel<CapybaraEntity>> {
    ...
    private static final ResourceLocation TOP_HAT_TEXTURE =
            new ResourceLocation(Capybara.MOD_ID, "textures/entity/capybaracosmetics/top_hat.png");

    private static final float PX = 1.0F / 16.0F;

    private final TopHatModel<CapybaraEntity> hatModel;

    public TopHatLayer(RenderLayerParent<CapybaraEntity, CapybaraModel<CapybaraEntity>> parent,
    ...
    public void render(PoseStack poseStack, MultiBufferSource buffer, int packedLight,
        ...
        if (!capy.hasTopHat() || capy.isInvisible()) return;
        ...
        this.hatModel.renderToBuffer(
                poseStack,
                buffer.getBuffer(this.hatModel.renderType(TOP_HAT_TEXTURE)),
                packedLight,
