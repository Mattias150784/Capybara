...
public class EarsLayer extends RenderLayer<CapybaraEntity, CapybaraModel<CapybaraEntity>> {
    private final CapybaraModel<CapybaraEntity> model;

    public EarsLayer(RenderLayerParent<CapybaraEntity, CapybaraModel<CapybaraEntity>> parent) {
        super(parent);
    ...
    public void render(PoseStack poseStack, MultiBufferSource bufferSource, int packedLight,
        ...
        int variant = Math.max(1, capybara.getEarsVariant());
        ResourceLocation texture = new ResourceLocation(
                Capybara.MOD_ID,
                "textures/entity/capybaraearcolor/capybara_ears_" + variant + ".png"
        );
