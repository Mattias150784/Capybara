...
public class SnoutLayer extends RenderLayer<CapybaraEntity, CapybaraModel<CapybaraEntity>> {
    private final CapybaraModel<CapybaraEntity> model;

    public SnoutLayer(RenderLayerParent<CapybaraEntity, CapybaraModel<CapybaraEntity>> parent) {
        super(parent);
    ...
    public void render(PoseStack poseStack, MultiBufferSource bufferSource, int packedLight,
        ...
        int variant = Math.max(1, capybara.getSnoutVariant());
        ResourceLocation texture = new ResourceLocation(
                Capybara.MOD_ID,
                "textures/entity/capybarasnoutcolor/capybara_snout_" + variant + ".png"
        );
